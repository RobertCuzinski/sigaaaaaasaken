getgenv().settings = {
    ["PutedScriptInAutoExecute"] = false, -- VERY IMPORTANT if you put script in auto execute folder u HAVE to make this true
    ["AutoFarmSettings"] = {
        ...
        ["AutoEatGhostBurgerOrCloneOrCrouch"] = true, -- Automatically eats ghost burger, makes clone or crouches when killer uses highligh ability and at start
        ...
        ["FarmSettings"] = {
            ["KillerSurvivorFind"] = "Lowest", -- Closest, LowestHP, Target1RandomPlr (Lowest by default)
    ...
    ["AutoGenerator"] = {
        ...
        ["AutoFinish1TaskWhenEntringGenerator"] = true -- false by default (bro wtf ts is so fking long)
    },
    ["FarmUntil"] = {
        ["Enabled"] = false, -- false by default
        ["NumberOfMoney"] = 10000, -- 10000 by default
        ["AllSurvivorsMilestones"] = false, -- false by default
        ["AllKillersMilestones"] = false, -- false by default
        ["SurvivorsMilestone"] = 4, -- 2 by default
        ["KillerMilestone"] = 4, -- 2 by default
    },
    ["AutoBuy"] = {
        ["Enabled"] = true, -- false by default
        ["Killers"] = true, -- true by default
        ["Survivors"] = true, -- true by default
        ["Emotes"] = false, -- false by default
        ["SurvivorsSkins"] = false, -- false by default
        ["KillersSkins"] = false, -- false by default
    },
    ["FarmAsKiller"] = {
        ["Enabled"] = false, -- true by default
        ["UseHitboxExpander"] = true, -- -- WARNING!!! Balant, dont work with desync and false by default
    },
    ...
    ["Webhook"] = {
        ["Enabled"] = true, -- Sends message after finishing auto farm 
        ["WebhookLink"] = "https://discord.com/api/webhooks/1510584596796801095/5hyE6lU3hJ23io8aBQVcDIYV8am9vBgvkUj7lHWQcUPaym-nAnuuf37BNYKaB-fbFPEY", -- Webhook link
